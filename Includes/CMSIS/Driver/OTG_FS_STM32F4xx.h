...
#define OTG_FS_USBD_DRIVER_CONNECTED   (1U << 2)
...
#define  OTG_FS_GUSBCFG_TOCAL_MSK           ((uint32_t)    7U  <<  OTG_FS_GUSBCFG_TOCAL_POS)
...
#define  OTG_FS_GRXSTSR_CHNUM_MSK           ((uint32_t) 0x0FU  << OTG_FS_GRXSTSR_CHNUM_POS)
...
#define  OTG_FS_GRXSTSR_EPNUM_MSK           ((uint32_t) 0x0FU  << OTG_FS_GRXSTSR_EPNUM_POS)
...
#define  OTG_FS_GRXSTSP_CHNUM_MSK           ((uint32_t) 0x0FU  << OTG_FS_GRXSTSP_CHNUM_POS)
...
#define  OTG_FS_GRXSTSP_EPNUM_MSK           ((uint32_t) 0x0FU  << OTG_FS_GRXSTSP_EPNUM_POS)
...
#define  OTG_FS_GRXFSIZ_RXFD_MSK            ((uint32_t)0xFFFFU << OTG_FS_GRXFSIZ_RXFD_POS)
...
#define  OTG_FS_HNPTXFSIZ_NPTXFSA_MSK       ((uint32_t)0xFFFFU << OTG_FS_HNPTXFSIZ_NPTXFSA_POS)
...
#define  OTG_FS_DIEPTXF0_TX0FSA_MSK         ((uint32_t)0xFFFFU << OTG_FS_DIEPTXF0_TX0FSA_POS)
...
#define  OTG_FS_HNPTXSTS_NPTXFSAV_MSK       ((uint32_t)0xFFFFU << OTG_FS_HNPTXSTS_NPTXFSAV_POS)
...
#define  OTG_FS_HPTXFSIZ_PTXSA_MSK          ((uint32_t)0xFFFFU << OTG_FS_HPTXFSIZ_PTXSA_POS)
...
#define  OTG_FS_DIEPTXFx_INEPTXSA_MSK       ((uint32_t)0xFFFFU << OTG_FS_DIEPTXFx_INEPTXSA_POS)
...
#define  OTG_FS_HCFG_FSLSPCS_MSK            ((uint32_t)    3U  << OTG_FS_HCFG_FSLSPCS_POS)
...
#define  OTG_FS_HFIR_FRIVL_MSK              ((uint32_t)0xFFFFU << OTG_FS_HFIR_FRIVL_POS)
...
#define  OTG_FS_HFNUM_FRNUM_MSK             ((uint32_t)0xFFFFU << OTG_FS_HFNUM_FRNUM_POS)
...
#define  OTG_FS_HPTXSTS_PTXFSAVL_MSK        ((uint32_t)0xFFFFU << OTG_FS_HPTXSTS_PTXFSAVL_POS)
...
#define  OTG_FS_HAINT_HAINT_MSK             ((uint32_t)0xFFFFU << OTG_FS_HAINT_HAINT_POS)
...
#define  OTG_FS_HAINTMSK_HAINTM_MSK         ((uint32_t)0xFFFFU << OTG_FS_HAINTMSK_HAINTM_POS)
...
#define  OTG_FS_HCCHARx_MPSIZ_MSK           ((uint32_t)0x7FFU  << OTG_FS_HCCHARx_MPSIZ_POS)
...
#define  OTG_FS_HCTSIZx_XFRSIZ_MSK          ((uint32_t)0x7FFFFU<<OTG_FS_HCTSIZx_XFRSIZ_POS)
...
#define  OTG_FS_DCFG_DSPD_MSK               ((uint32_t)    3U  << OTG_FS_DCFG_DSPD_POS)
...
#define  OTG_FS_DVBUSDIS_VBUSDT_MSK         ((uint32_t)0xFFFFU << OTG_FS_DVBUSDIS_VBUSDT_POS)
...
#define  OTG_FS_DVBUSPULSE_DVBUSP_MSK       ((uint32_t)0xFFFU  << OTG_FS_DVBUSPULSE_DVBUSP_POS)
...
#define  OTG_FS_DIEPEMPMSK_INEPTXFEM_MSK    ((uint32_t)0xFFFFU << OTG_FS_DIEPEMPMSK_INEPTXFEM_POS)
...
#define  OTG_FS_DIEPCTL0_MPSIZ_MSK          ((uint32_t)    3U  << OTG_FS_DIEPCTL0_MPSIZ_POS)
...
#define  OTG_FS_DIEPCTLx_MPSIZ_MSK          ((uint32_t)0x7FFU  << OTG_FS_DIEPCTLx_MPSIZ_POS)
...
#define  OTG_FS_DIEPCTLx_EONUM              ((uint32_t)    1U  << 16)
...
#define  OTG_FS_DOEPCTL0_MPSIZ_MSK          ((uint32_t)    3U  << OTG_FS_DOEPCTL0_MPSIZ_POS)
...
#define  OTG_FS_DOEPCTLx_MPSIZ_MSK          ((uint32_t)0x7FFU  << OTG_FS_DOEPCTLx_MPSIZ_POS)
...
#define  OTG_FS_DOEPCTLx_EONUM              ((uint32_t)    1U  << 16)
...
#define  OTG_FS_DIEPTSIZ0_XFRSIZ_MSK        ((uint32_t) 0x7FU  << OTG_FS_DIEPTSIZ0_XFRSIZ_POS)
...
#define  OTG_FS_DOEPTSIZ0_XFRSIZ_MSK        ((uint32_t) 0x7FU  << OTG_FS_DOEPTSIZ0_XFRSIZ_POS)
...
#define  OTG_FS_DIEPTSIZx_XFRSIZ_MSK        ((uint32_t)0x7FFFFU<<OTG_FS_DIEPTSIZx_XFRSIZ_POS)
...
#define  OTG_FS_DTXFSTSx_INEPTFSAV_MSK      ((uint32_t)0xFFFFU << OTG_FS_DTXFSTSx_INEPTFSAV_POS)
...
#define  OTG_FS_DOEPTSIZx_XFRSIZ_MSK        ((uint32_t)0x7FFFFU<<OTG_FS_DOEPTSIZx_XFRSIZ_POS)
