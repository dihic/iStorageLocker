...
#define OTG_HS_USBD_DRIVER_INITIALIZED (1U)
#define OTG_HS_USBD_DRIVER_POWERED     (1U << 1)
#define OTG_HS_USBD_DRIVER_CONNECTED   (1U << 2)
#define OTG_HS_USBH_DRIVER_INITIALIZED (1U << 4)
#define OTG_HS_USBH_DRIVER_POWERED     (1U << 5)

#define __GPIOx_CLK_ENABLE(x)           \
 ((x == GPIOA) ? __GPIOA_CLK_ENABLE() : \
  (x == GPIOB) ? __GPIOB_CLK_ENABLE() : \
  (x == GPIOC) ? __GPIOC_CLK_ENABLE() : \
  (x == GPIOD) ? __GPIOD_CLK_ENABLE() : \
  (x == GPIOE) ? __GPIOE_CLK_ENABLE() : \
  (x == GPIOF) ? __GPIOF_CLK_ENABLE() : \
  (x == GPIOG) ? __GPIOG_CLK_ENABLE() : \
  (x == GPIOH) ? __GPIOH_CLK_ENABLE() : \
  (x == GPIOI) ? __GPIOI_CLK_ENABLE() : \
  NULL)
...
#if     (RTE_USB_OTG_HS == 1)
#if    ((RTE_USB_OTG_HS_HOST == 1) && (RTE_OTG_HS_VBUS_PIN == 0))
...
/* Define USB Host Overcurren Pin active state */
...
#define  OTG_HS_GUSBCFG_TOCAL_MSK           ((uint32_t)    7U  <<  OTG_HS_GUSBCFG_TOCAL_POS)
...
#define  OTG_HS_GRXSTSR_CHNUM_MSK           ((uint32_t) 0x0FU << OTG_HS_GRXSTSR_CHNUM_POS)
...
#define  OTG_HS_GRXSTSR_EPNUM_MSK           ((uint32_t) 0x0FU << OTG_HS_GRXSTSR_EPNUM_POS)
...
#define  OTG_HS_GRXSTSP_CHNUM_MSK           ((uint32_t) 0x0FU << OTG_HS_GRXSTSP_CHNUM_POS)
...
#define  OTG_HS_GRXSTSP_EPNUM_MSK           ((uint32_t) 0x0FU << OTG_HS_GRXSTSP_EPNUM_POS)
...
#define  OTG_HS_GRXFSIZ_RXFD_MSK            ((uint32_t)0xFFFFU << OTG_HS_GRXFSIZ_RXFD_POS)
...
#define  OTG_HS_HNPTXFSIZ_NPTXFSA_MSK       ((uint32_t)0xFFFFU << OTG_HS_HNPTXFSIZ_NPTXFSA_POS)
...
#define  OTG_HS_DIEPTXF0_TX0FSA_MSK         ((uint32_t)0xFFFFU << OTG_HS_DIEPTXF0_TX0FSA_POS)
...
#define  OTG_HS_HNPTXSTS_NPTXFSAV_MSK       ((uint32_t)0xFFFFU << OTG_HS_HNPTXSTS_NPTXFSAV_POS)
...
#define  OTG_HS_GI2CCTL_RWDATA_MSK          ((uint32_t) 0xFFU  << OTG_HS_GI2CCTL_RWDATA_POS)
...
#define  OTG_HS_GI2CCTL_ADDR_MSK            ((uint32_t) 0xFFU  << OTG_HS_GI2CCTL_ADDR_POS)
...
#define  OTG_HS_HPTXFSIZ_PTXSA_MSK          ((uint32_t)0xFFFFU << OTG_HS_HPTXFSIZ_PTXSA_POS)
...
#define  OTG_HS_DIEPTXFx_INEPTXSA_MSK       ((uint32_t)0xFFFFU << OTG_HS_DIEPTXFx_INEPTXSA_POS)
...
#define  OTG_HS_HCFG_FSLSPCS_MSK            ((uint32_t)    3U  << OTG_HS_HCFG_FSLSPCS_POS)
...
#define  OTG_HS_HFIR_FRIVL_MSK              ((uint32_t)0xFFFFU << OTG_HS_HFIR_FRIVL_POS)
...
#define  OTG_HS_HFNUM_FRNUM_MSK             ((uint32_t)0xFFFFU << OTG_HS_HFNUM_FRNUM_POS)
...
#define  OTG_HS_HPTXSTS_PTXFSAVL_MSK        ((uint32_t)0xFFFFU << OTG_HS_HPTXSTS_PTXFSAVL_POS)
...
#define  OTG_HS_HAINT_HAINT_MSK             ((uint32_t)0xFFFFU << OTG_HS_HAINT_HAINT_POS)
...
#define  OTG_HS_HAINTMSK_HAINTM_MSK         ((uint32_t)0xFFFFU << OTG_HS_HAINTMSK_HAINTM_POS)
...
#define  OTG_HS_HCCHARx_MPSIZ_MSK           ((uint32_t)0x7FFU  << OTG_HS_HCCHARx_MPSIZ_POS)
...
#define  OTG_HS_HCSPLTx_PRTADDR_MSK         ((uint32_t) 0x7FU  << OTG_HS_HCSPLTx_PRTADDR_POS)
...
#define  OTG_HS_HCTSIZx_XFRSIZ_MSK          ((uint32_t)0x7FFFFU<<OTG_HS_HCTSIZx_XFRSIZ_POS)
...
#define  OTG_HS_DCFG_DSPD_MSK               ((uint32_t)    3U  << OTG_HS_DCFG_DSPD_POS)
...
#define  OTG_HS_DVBUSDIS_VBUSDT_MSK         ((uint32_t)0xFFFFU << OTG_HS_DVBUSDIS_VBUSDT_POS)
...
#define  OTG_HS_DVBUSPULSE_DVBUSP_MSK       ((uint32_t)0xFFFU  << OTG_HS_DVBUSPULSE_DVBUSP_POS)
...
#define  OTG_HS_DIEPEMPMSK_INEPTXFEM_MSK    ((uint32_t)0xFFFFU << OTG_HS_DIEPEMPMSK_INEPTXFEM_POS)
...
#define  OTG_HS_DIEPCTLx_MPSIZ_MSK          ((uint32_t)0x7FFU  << OTG_HS_DIEPCTLx_MPSIZ_POS)
...
#define  OTG_HS_DOEPCTL0_MPSIZ_MSK          ((uint32_t)    3U  << OTG_HS_DOEPCTL0_MPSIZ_POS)
...
#define  OTG_HS_DOEPCTLx_MPSIZ_MSK          ((uint32_t)0x7FFU  << OTG_HS_DOEPCTLx_MPSIZ_POS)
...
#define  OTG_HS_DIEPTSIZ0_XFRSIZ_MSK        ((uint32_t) 0x7FU  << OTG_HS_DIEPTSIZ0_XFRSIZ_POS)
...
#define  OTG_HS_DOEPTSIZ0_XFRSIZ_MSK        ((uint32_t) 0x7FU  << OTG_HS_DOEPTSIZ0_XFRSIZ_POS)
...
#define  OTG_HS_DIEPTSIZx_XFRSIZ_MSK        ((uint32_t)0x7FFFFU<<OTG_HS_DIEPTSIZx_XFRSIZ_POS)
...
#define  OTG_HS_DTXFSTSx_INEPTFSAV_MSK      ((uint32_t)0xFFFFU << OTG_HS_DTXFSTSx_INEPTFSAV_POS)
...
#define  OTG_HS_DOEPTSIZx_XFRSIZ_MSK        ((uint32_t)0x7FFFFU<<OTG_HS_DOEPTSIZx_XFRSIZ_POS)
